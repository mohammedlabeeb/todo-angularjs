...
(function () {
	...
	describe('Todo Controller', function () {
		...
		beforeEach(inject(function ($controller, $rootScope, localStorage, $httpBackend) {
		...
		describe('having undo actions', function () {
			var ctrl;
			...
			it('undoRedoChanges() get previous actions - MarkAll', function () {
				// Mark All
				scope.markAll(true);
				scope.undoRedoChanges('undo');
				expect(scope.completedCount).toBe(2);
				scope.$digest();
			});
		});
